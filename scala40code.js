...
var scala = {
    ...
    inizializzazioni: function(){
		...
		if (this.numeroavversari==3){yg=145,ya1=30,ya2=66,ya3=102,ylim=192,wbig=83,hbig=35,xbig=45;
			...
			'<img src="images/totalea3.png" height="35" width="35">' );
		...
		if (this.numeroavversari>1){
			...
			'<img src="images/totalea2.png" height="35" width="35">' );
...
/*	   	   <div id="totaleavversario1" style="top: 50px; left: 35px;" class="contatore">    <img src="images/vassoiod.png" height="40" width="90"> 
	   ...
	   <div id="totalegiocatore" style="top: 110px; left: 35px;" class="contatore">    <img src="images/vassoiod.png" height="40" width="90"> 
	   			<div id="digit3" class="digit1" style="top: 1px; left: 3px; background-position: -0px 0px; "  > </div>
	   			<div id="digit2" class="digit1" style="top: 1px; left: 31px; background-position: -0px 0px;"  > </div>
	   			<div id="digit1" class="digit1" style="top: 1px; left: 59px; background-position: -0px 0px;"  > </div>
	   	   </div>  <!--totalegiocatore-->
	   <div id="totalelimite" style="top: 170px; left: 72px;" class="contatore">    <img src="images/vassoiod.png" height="25" width="54"> 
	   ...
	   <div id="totalepartite" style="top: 215px; left: 72px;" class="contatore">    <img src="images/vassoiod.png" height="25" width="54"> 
	   			<div id="digit3" class="digit2" style="top: 1px; left: 3px; background-position: -0px 0px; "  > </div>
	   			<div id="digit2" class="digit2" style="top: 1px; left: 20px; background-position: -0px 0px;"  > </div>
	   			<div id="digit1" class="digit2" style="top: 1px; left: 37px; background-position: -0px 0px;"  > </div>
	   	   </div>  <!--totalepartite-->  */
...
/*
		...
		'<div id="punti'+
		nome+'" style="top: 2px; left: 725px;" class="contatore">  <img src="images/vassoiod.png" height="50" width="130">'+
